# -*- coding: utf-8 -*-
# Generated by Django 1.10.1 on 2017-08-28 05:21
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'permissions': (('view_dias_sem_expediente', 'Can see dias sem expediente'),),
            },
        ),
        migrations.CreateModel(
            name='Frequencia',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dias', multiselectfield.db.fields.MultiSelectField(
                    choices=[('Segunda-Feira', 'Segunda-Feira'), ('Terça-Feira', 'Terça-Feira'),
                             ('Quarda-Feira', 'Quarda-Feira'), ('Quinta-Feira', 'Quinta-Feira'),
                             ('Sexta-Feira', 'Sexta-Feira'), ('Sábado-Feira', 'Sábado-Feira')], max_length=76,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sexo',
                 models.CharField(choices=[('Masculino', 'Masculino'), ('Feminino', 'Feminino')], max_length=30)),
                ...
                ('situacao', models.CharField(choices=[('Ativo', 'Ativo'), ('Desativado', 'Desativado')], max_length=30,
